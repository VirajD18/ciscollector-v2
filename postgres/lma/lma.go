...
func CheckLogDest() helper.CheckHelper {
	result := &model.Result{
		Control:   "3.1.2",
...
func CheckLogCol() helper.CheckHelper {
	result := &model.Result{
		Control:   "3.1.3",
...
func CheckLogDir() helper.CheckHelper {
	result := &model.Result{
		Control:   "3.1.4",
...
func CheckLogFile() helper.CheckHelper {
	result := &model.Result{
		Control:   "3.1.5",
...
func CheckLogFilePerm() helper.CheckHelper {
	result := &model.Result{
		Control: "3.1.6",
...
func CheckLogTrunc() helper.CheckHelper {
	result := &model.Result{
		Control:   "3.1.7",
...
func CheckLogLT() helper.CheckHelper {
	result := &model.Result{
		Control:   "3.1.8",
...
func CheckLogFileSize() helper.CheckHelper {
	result := &model.Result{
		Control: "3.1.9",
...
func CheckSyslog() helper.CheckHelper {
	result := &model.Result{
		Control:   "3.1.10",
...
func CheckSyslogSuppr() helper.CheckHelper {
	result := &model.Result{
		Control: "3.1.11",
...
func CheckServLogMsgSize() helper.CheckHelper {
	result := &model.Result{
		Control: "3.1.12",
...
func CheckSyslogMsg() helper.CheckHelper {
	result := &model.Result{
		Control:   "3.1.13",
...
func CheckServLogMsg() helper.CheckHelper {
	result := &model.Result{
		Control:   "3.1.14",
...
func CheckSQLStat() helper.CheckHelper {
	result := &model.Result{
		Control:   "3.1.15",
...
func CheckDebugPrintParse() helper.CheckHelper {
	result := &model.Result{
		Control:   "3.1.16",
...
func CheckDebugPrintRewritten() helper.CheckHelper {
	result := &model.Result{
		Control:   "3.1.17",
		Rationale: `Enabling any of the DEBUG printing variables may cause the logging of sensitive information that would otherwise be omitted based on the configuration of the other logging settings.`,
...
func CheckDebugPrintPlan() helper.CheckHelper {
	result := &model.Result{
		Control:   "3.1.18",
		Rationale: `Enabling any of the DEBUG printing variables may cause the logging of sensitive information that would otherwise be omitted based on the configuration of the other logging settings.`,
...
func CheckDebugPrettyPrint() helper.CheckHelper {
	result := &model.Result{
		Control:   "3.1.19",
...
func CheckLogConnections() helper.CheckHelper {
	result := &model.Result{
		Control: "3.1.20",
...
func CheckLogDisconnections() helper.CheckHelper {
	result := &model.Result{
		Control: "3.1.21",
...
func ChecklogErrorVerbosity() helper.CheckHelper {
	result := &model.Result{
		Control:   "3.1.22",
...
func CheckLogHostname() helper.CheckHelper {
	result := &model.Result{
		Control: "3.1.23",
...
func ChecklogLinePrefix() helper.CheckHelper {
	result := &model.Result{
		Control: "3.1.24",
...
func CheckLogStatement() helper.CheckHelper {
	result := &model.Result{
		Control:   "3.1.25",
...
func CheckLogTimezone() helper.CheckHelper {
	result := &model.Result{
		Control:   "3.1.26",
...
func CheckSharedPreloadLibraries() helper.CheckHelper {
	result := &model.Result{
		Control: "3.2",
